      ...
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Welcome to Zein land</span>
          </p>
...
<html lang="en">
  <head>
    ...
    />
    <link
      href="<?= base_url('assets/front/'); ?>https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css"
      rel="stylesheet"
    />
    <link href="<?= base_url('assets/front/'); ?>lib/flaticon/font/flaticon.css" rel="stylesheet" />
    <link href="<?= base_url('assets/front/'); ?>lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            <a href="<?= base_url('http://localhost/cms/admin/caraousel'); ?>" class="nav-item nav-link">Home</a>
            <?php foreach($kategori as $kate){ ?>
                <a href="<?= base_url('home/kategori/'.$kate['id_kategori']) ?>" class="nav-item nav-link">
                    <?= $kate['nama_kategori'] ?>
                </a>
        ...
        <div class="col-lg-12">
          <div class="d-flex flex-column text-left mb-3">
            <p class="section-title pr-5">
              <span class="pr-2"> Detail Page </span>
            </p>
  ...
  <body>
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Welcome to Mawar land</span>
          </p>
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              ...
              <div class="card-body bg-light text-center p-4">
                ...
                <div class="d-flex justify-content-center mb-3">
                  <small class="mr-3"
                    ><i class="fa fa-user text-primary"></i><?= $uu['nama'] ?></small
                  >
                  <small class="mr-3"
                    ><i class="fa fa-folder text-primary"></i><?= $uu['nama_kategori'] ?></small
                  >
                </div>
