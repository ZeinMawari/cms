      ...
      <tbody class="table-border-bottom-0">
        <?php foreach ($user as $aa) { ?>
          <tr>
            ...
            <td><?= $aa['level'] ?></td>
            <td>
              <a href="<?php echo site_url('admin/user/delete_data/'.$aa['id_user']);?>" class="btn btn-sm btn-danger" onClick="return confirm('Apakah anda yakin menghapus data ini')"><span class="tf-icons bx bx-trash delete"></span></a>
