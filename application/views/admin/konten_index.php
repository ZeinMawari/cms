      ...
      <tbody class="table-border-bottom-0">
        <?php $no=1; foreach ($konten as $aa) { ?>
          <tr>
            ...
            <td>
              <a href="<?php echo site_url('admin/konten/delete_data/'.$aa['foto']);?>" class="btn btn-sm btn-danger" onClick="return confirm('Apakah anda yakin menghapus data ini')"><span class="tf-icons bx bx-trash delete"></span></a>
              <!-- Button trigger modal -->
