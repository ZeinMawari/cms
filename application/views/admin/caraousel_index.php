...
<div class="col-md-12 mb-3 mt-3">
    <div class="card h-100">
        ...
        <div class="card-body">
            ...
            <a href="<?php echo site_url('admin/caraousel/delete_data/'.$aa['foto']);?>" class="btn btn-sm btn-danger" onClick="return confirm('Apakah anda yakin menghapus data ini')"><span class="tf-icons bx bx-trash delete"></span></a>
        </div>
    </div>
</div>
<?php } ?>