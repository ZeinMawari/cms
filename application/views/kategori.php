                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        <div class="card border-0 shadow-sm mb-2">
                                            <img class="card-img-top img-fluid" src="<?= base_url('assets/upload/konten/'.$uu['foto']) ?>" alt="<?= $uu['judul'] ?>" />
                                            <div class="card-body bg-light text-center py-4">
                                                <h4 class="h5"><?= $uu['judul'] ?></h4>
                                                <div class="d-flex justify-content-center mb-3">
                                                    <small class="mr-1"><i class="fa fa-user text-primary"></i> <?= $uu['nama'] ?></small>
                                                    <small class="mr-1"><i class="fa fa-folder text-primary"></i> <?= $uu['nama_kategori'] ?></small>
                                                </div>
                                                <a href="<?= base_url('home/artikel/'.$uu['slug']) ?>" class="btn btn-primary px-3 py-2">Baca Selengkapnya</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
